...
import dunemod.cards.BaseCard;
import dunemod.characters.TheFremen;
import dunemod.relics.BaseRelic;
import dunemod.util.GeneralUtils;
import dunemod.util.KeywordInfo;
import dunemod.util.TextureLoader;
...
@SpireInitializer
public class DuneMod implements
    ...
    private static final Color cardColor = new Color(255f, 87f/255f, 51f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(TheFremen.Enums.CARD_COLOR, cardColor,
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(DuneMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheFremen(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, TheFremen.Enums.THE_FREMEN);
    }
    ...
    public void receivePostCreateStartingRelics(AbstractPlayer.PlayerClass playerClass, ArrayList<String> arrayList) {
        if(playerClass.equals(TheFremen.Enums.THE_FREMEN)){
            arrayList.add("FactionRelic");
            System.out.println("RELIC ADDED");;
        }
    }
}
