...
import dunemod.cards.Crysknife;
import dunemod.cards.Defend;
import dunemod.relics.GholaEyes;

import java.util.ArrayList;

import static dunemod.DuneMod.characterPath;
import static dunemod.DuneMod.makeID;

public class TheFremen extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheFremen"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FREMEN;
    ...
    public TheFremen() {
        super(NAMES[0], Enums.THE_FREMEN,
